...
namespace Microservices.Common.AppMetrics
{
  public static class Extensions
  {
    ...
    public static IShellBuilder AddMetrics(this IShellBuilder builder,
         string metricsSectionName = MetricsSectionName, string appSectionName = ApplicationSectionName)
    {
      ...
      {
        appSectionName = ApplicationSectionName;
      }

      var metricsOptions = builder.GetOptions<Options.MetricsOptions>(metricsSectionName);
      var appOptions = builder.GetOptions<ApplicationOptions>(appSectionName);
    ...
    private static MetricsWebHostOptions GetMetricsWebHostOptions(Options.MetricsOptions metricsOptions)
    {
    ...
    public static IApplicationBuilder UseMetrics(this IApplicationBuilder app)
    {
      ...
      {
        options = scope.ServiceProvider.GetService<Options.MetricsOptions>();
      }
